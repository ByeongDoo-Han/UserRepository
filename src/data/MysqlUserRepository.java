...
public class MysqlUserRepository implements UserRepository {
    ...
    public MysqlUserRepository() {
        System.out.println("Mysql 기반의 DB가 실행됩니다.");
    }


    @Override
    public void saveUser(User user) {
        System.out.println("Mysql 기반의 DB에서 유저를 저장합니다.");
        users.add(user);
    }

    @Override
    public User findUser(String loginId) throws UserNotFoundException {
        System.out.println("Mysql 기반의 DB에서 유저를 찾습니다.");
 ...
 * 그러면, App 단계에서, 해당 예외를 잡아서 어떻게 처리할지 작성해주면 되겠죠.
 */